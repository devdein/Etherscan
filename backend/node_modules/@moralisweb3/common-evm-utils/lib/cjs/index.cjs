...
var EvmTransaction = /** @class */ (function () {
    ...
    EvmTransaction.parse = function (data, core) {
        ...
        return ({
            ...
            hash: data.hash,
            type: commonCore.maybe(data.type, function (value) { return +value; }),
...
// Methods
function getRequestUrlParams$y(_) {
    return {};
}
...
function deserializeResponse$w(jsonResponse, request, core) {
    return (jsonResponse !== null && jsonResponse !== void 0 ? jsonResponse : []).map(function (nft) {
        ...
        return EvmNft.create(__assign(__assign({}, commonCore.toCamelCase(nft)), { chain: EvmChainResolver.resolve(request.chain, core), amount: nft.amount ? parseInt(nft.amount, 10) : undefined, ownerOf: EvmAddress.create(nft.owner_of, core), lastMetadataSync: commonCore.dateInputToDate(nft.last_metadata_sync), lastTokenUriSync: commonCore.dateInputToDate(nft.last_token_uri_sync) }), core);
    });
}
...
function deserializeResponse$r(jsonResponse, request, core) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (nft) {
        return EvmNft.create(__assign(__assign({}, commonCore.toCamelCase(nft)), { chain: EvmChainResolver.resolve(request.chain, core), ownerOf: EvmAddress.create(nft.owner_of, core), lastMetadataSync: new Date(nft.last_metadata_sync), lastTokenUriSync: new Date(nft.last_token_uri_sync) }), core);
    });
}
...
function deserializeResponse$q(jsonResponse, request, core) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (nft) {
        return EvmNft.create(__assign(__assign({}, commonCore.toCamelCase(nft)), { chain: EvmChainResolver.resolve(request.chain, core), ownerOf: EvmAddress.create(nft.owner_of, core), lastMetadataSync: new Date(nft.last_metadata_sync), lastTokenUriSync: new Date(nft.last_token_uri_sync) }));
    });
}
...
function deserializeResponse$k(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function (nft) {
        return EvmNft.create({
            ...
            lastMetadataSync: commonCore.dateInputToDate(nft.last_metadata_sync),
            lastTokenUriSync: commonCore.dateInputToDate(nft.last_token_uri_sync),
        });
    });
}
...
function deserializeResponse$g() {
    return {
        success: true,
    };
}
