...
type OperationId$G = 'getNativeBalance';
type PathParams$v = operations$1[OperationId$G]['parameters']['path'];
type QueryParams$C = operations$1[OperationId$G]['parameters']['query'];
type RequestParams$D = PathParams$v & QueryParams$C;
type SuccessResponse$G = operations$1[OperationId$G]['responses']['200']['content']['application/json'];
interface GetNativeBalanceRequest extends Camelize<Omit<RequestParams$D, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetNativeBalanceJSONRequest = ReturnType<typeof serializeRequest$E>;
type GetNativeBalanceJSONResponse = SuccessResponse$G;
type GetNativeBalanceResponse = ReturnType<typeof deserializeResponse$G>;
...
declare function deserializeResponse$G(jsonResponse: GetNativeBalanceJSONResponse): {
    balance: EvmNative;
};
declare function serializeRequest$E(request: GetNativeBalanceRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    toBlock: number | undefined;
    address: string;
};

type OperationId$F = 'getNativeBalancesForAddresses';
type QueryParams$B = operations$1[OperationId$F]['parameters']['query'];
type RequestParams$C = QueryParams$B;
type SuccessResponse$F = operations$1[OperationId$F]['responses']['200']['content']['application/json'];
interface GetNativeBalancesForAddressesRequest extends Camelize<Omit<RequestParams$C, 'chain' | 'wallet_addresses'>> {
    chain?: EvmChainish;
    walletAddresses: EvmAddressish[];
}
type GetNativeBalancesForAddressesJSONRequest = ReturnType<typeof serializeRequest$D>;
type GetNativeBalancesForAddressesJSONResponse = SuccessResponse$F;
type GetNativeBalancesForAddressesResponse = ReturnType<typeof deserializeResponse$F>;
...
declare function deserializeResponse$F(jsonResponse: GetNativeBalancesForAddressesJSONResponse, request: GetNativeBalancesForAddressesRequest, core: Core): {
    chain: EvmChain;
    blockNumber: string;
    blockTimestamp: string;
...
declare function serializeRequest$D(request: GetNativeBalancesForAddressesRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
...
type OperationId$E = 'getBlock';
type PathParams$u = operations$1[OperationId$E]['parameters']['path'];
type QueryParams$A = operations$1[OperationId$E]['parameters']['query'];
type RequestParams$B = PathParams$u & QueryParams$A;
type SuccessResponse$E = operations$1[OperationId$E]['responses']['200']['content']['application/json'];
interface GetBlockRequest extends Camelize<Omit<RequestParams$B, 'chain'>> {
    chain?: EvmChainish;
}
type GetBlockJSONRequest = ReturnType<typeof serializeRequest$C>;
type GetBlockJSONResponse = SuccessResponse$E;
type GetBlockResponse = ReturnType<typeof deserializeResponse$E>;
...
declare function deserializeResponse$E(jsonResponse: GetBlockJSONResponse, request: GetBlockRequest, core: Core): EvmBlock;
declare function serializeRequest$C(request: GetBlockRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    blockNumberOrHash: string;
};

type OperationId$D = 'getDateToBlock';
type QueryParams$z = operations$1[OperationId$D]['parameters']['query'];
type RequestParams$A = QueryParams$z;
type SuccessResponse$D = operations$1[OperationId$D]['responses']['200']['content']['application/json'];
interface GetDateToBlockRequest extends Camelize<Omit<RequestParams$A, 'chain' | 'date'>> {
    chain?: EvmChainish;
    date: DateInput;
}
type GetDateToBlockJSONRequest = ReturnType<typeof serializeRequest$B>;
type GetDateToBlockJSONResponse = SuccessResponse$D;
type GetDateToBlockResponse = ReturnType<typeof deserializeResponse$D>;
...
declare function deserializeResponse$D(jsonResponse: GetDateToBlockJSONResponse): EvmBlockDate;
declare function serializeRequest$B(request: GetDateToBlockRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    date: string;
};

type OperationId$C = 'getPairAddress';
type PathParams$t = operations$1[OperationId$C]['parameters']['path'];
type QueryParams$y = operations$1[OperationId$C]['parameters']['query'];
type RequestParams$z = PathParams$t & QueryParams$y;
type SuccessResponse$C = operations$1[OperationId$C]['responses']['200']['content']['application/json'];
interface GetPairAddressRequest extends Camelize<Omit<RequestParams$z, 'chain' | 'token0_address' | 'token1_address' | 'to_date'>> {
    chain?: EvmChainish;
    token0Address: EvmAddressish;
    token1Address: EvmAddressish;
    toDate?: DateInput;
}
type GetPairAddressJSONRequest = ReturnType<typeof serializeRequest$A>;
type GetPairAddressJSONResponse = SuccessResponse$C;
type GetPairAddressResponse = ReturnType<typeof deserializeResponse$C>;
...
declare function deserializeResponse$C(jsonResponse: GetPairAddressJSONResponse, request: GetPairAddressRequest, core: Core): {
    token0: {
        token: Erc20Token;
        blockNumber: string | undefined;
...
declare function serializeRequest$A(request: GetPairAddressRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
...
type OperationId$B = 'getPairReserves';
type PathParams$s = operations$1[OperationId$B]['parameters']['path'];
type QueryParams$x = operations$1[OperationId$B]['parameters']['query'];
type RequestParams$y = PathParams$s & QueryParams$x;
type SuccessResponse$B = operations$1[OperationId$B]['responses']['200']['content']['application/json'];
interface GetPairReservesRequest extends Camelize<Omit<RequestParams$y, 'chain' | 'pair_address' | 'to_date'>> {
    chain?: EvmChainish;
    pairAddress: EvmAddressish;
    toDate?: DateInput;
}
type GetPairReservesJSONRequest = ReturnType<typeof serializeRequest$z>;
type GetPairReservesJSONResponse = SuccessResponse$B;
type GetPairReservesResponse = ReturnType<typeof deserializeResponse$B>;
...
declare function serializeRequest$z(request: GetPairReservesRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    toBlock: string | undefined;
    toDate: string | undefined;
    pairAddress: string;
};
declare function deserializeResponse$B(jsonResponse: GetPairReservesJSONResponse): {
    reserve0?: string | undefined;
    reserve1?: string | undefined;
};

type OperationId$A = 'getContractEvents';
type PathParams$r = operations$1[OperationId$A]['parameters']['path'];
type QueryParams$w = operations$1[OperationId$A]['parameters']['query'];
type RequestParams$x = PathParams$r & QueryParams$w;
type SuccessResponse$A = operations$1[OperationId$A]['responses']['200']['content']['application/json'];
interface GetContractEventsRequest extends Camelize<Omit<RequestParams$x, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    abi: EvmAbiItem;
    fromDate?: DateInput;
...
type GetContractEventsJSONRequest = ReturnType<typeof serializeRequest$y>;
type GetContractEventsJSONResponse = SuccessResponse$A;
type GetContractEventsResponse = ReturnType<typeof deserializeResponse$A>;
...
declare function deserializeResponse$A(jsonResponse: GetContractEventsJSONResponse, request: GetContractEventsRequest, core: Core): EvmEvent[];
declare function serializeRequest$y(request: GetContractEventsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
...
type OperationId$z = 'getContractLogs';
type PathParams$q = operations$1[OperationId$z]['parameters']['path'];
type QueryParams$v = operations$1[OperationId$z]['parameters']['query'];
type RequestParams$w = PathParams$q & QueryParams$v;
type SuccessResponse$z = operations$1[OperationId$z]['responses']['200']['content']['application/json'];
interface GetContractLogsRequest extends Camelize<Omit<RequestParams$w, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    fromDate?: DateInput;
    toDate?: DateInput;
}
type GetContractLogsJSONRequest = ReturnType<typeof serializeRequest$x>;
type GetContractLogsJSONResponse = SuccessResponse$z;
type GetContractLogsResponse = ReturnType<typeof deserializeResponse$z>;
...
declare function serializeRequest$x(request: GetContractLogsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    blockNumber: string | undefined;
...
declare function deserializeResponse$z(jsonResponse: GetContractLogsJSONResponse, request: GetContractLogsRequest, core: Core): EvmTransactionLog[];

type OperationId$y = 'uploadFolder';
...
type UploadFolderJSONRequest = ReturnType<typeof serializeRequest$w>;
type UploadFolderJSONResponse = SuccessResponse$y;
type UploadFolderResponse = ReturnType<typeof deserializeResponse$y>;
...
declare function deserializeResponse$y(jsonResponse: UploadFolderJSONResponse): {
    path: string;
}[];
declare function serializeRequest$w(request: UploadFolderRequest): {
    abi: string;
};

type OperationId$x = 'getContractNFTs';
type PathParams$p = operations$1[OperationId$x]['parameters']['path'];
type QueryParams$u = operations$1[OperationId$x]['parameters']['query'];
type RequestParams$v = PathParams$p & QueryParams$u;
type SuccessResponse$x = operations$1[OperationId$x]['responses']['200']['content']['application/json'];
interface GetContractNFTsRequest extends Camelize<Omit<RequestParams$v, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetContractNFTsJSONRequest = ReturnType<typeof serializeRequest$v>;
type GetContractNFTsJSONResponse = SuccessResponse$x;
type GetContractNFTsResponse = ReturnType<typeof deserializeResponse$x>;
...
declare function deserializeResponse$x(jsonResponse: GetContractNFTsJSONResponse, request: GetContractNFTsRequest, core: Core): EvmNft[];
declare function serializeRequest$v(request: GetContractNFTsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
...
type OperationId$w = 'getMultipleNFTs';
type QueryParams$t = operations$1[OperationId$w]['parameters']['query'];
type BodyParams$1 = operations$1[OperationId$w]['requestBody']['content']['application/json'];
type RequestParams$u = QueryParams$t & BodyParams$1;
type SuccessElement = GetElementType<operations$1[OperationId$w]['responses']['200']['content']['application/json']>;
type SuccessResponse$w = (SuccessElement | null)[];
interface GetMultipleNFTsRequest extends Camelize<Omit<RequestParams$u, 'chain' | 'tokens'>> {
    chain?: EvmChainish;
    tokens: {
        tokenAddress: EvmAddressish;
        tokenId: string;
...
type GetMultipleNFTsJSONRequest = ReturnType<typeof serializeRequest$u>;
type GetMultipleNFTsJSONResponse = SuccessResponse$w;
type GetMultipleNFTsResponse = ReturnType<typeof deserializeResponse$w>;
...
declare function deserializeResponse$w(jsonResponse: GetMultipleNFTsJSONResponse, request: GetMultipleNFTsRequest, core: Core): (EvmNft | null)[];
declare function serializeRequest$u(request: GetMultipleNFTsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    normalizeMetadata: boolean | undefined;
    tokens: {
        tokenAddress: string;
...
type OperationId$v = 'getNFTContractMetadata';
type PathParams$o = operations$1[OperationId$v]['parameters']['path'];
type QueryParams$s = operations$1[OperationId$v]['parameters']['query'];
type RequestParams$t = PathParams$o & QueryParams$s;
type SuccessResponse$v = operations$1[OperationId$v]['responses']['200']['content']['application/json'];
interface GetNFTContractMetadataRequest extends Camelize<Omit<RequestParams$t, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetNFTContractMetadataJSONRequest = ReturnType<typeof serializeRequest$t>;
type GetNFTContractMetadataJSONResponse = SuccessResponse$v;
type GetNFTContractMetadataResponse = ReturnType<typeof deserializeResponse$v>;
...
declare function deserializeResponse$v(jsonResponse: GetNFTContractMetadataJSONResponse, request: GetNFTContractMetadataRequest, core: Core): EvmNftMetadata;
declare function serializeRequest$t(request: GetNFTContractMetadataRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    address: string;
};

type OperationId$u = 'getNFTContractTransfers';
type PathParams$n = operations$1[OperationId$u]['parameters']['path'];
type QueryParams$r = operations$1[OperationId$u]['parameters']['query'];
type RequestParams$s = PathParams$n & QueryParams$r;
type SuccessResponse$u = operations$1[OperationId$u]['responses']['200']['content']['application/json'];
interface GetNFTContractTransfersRequest extends Camelize<Omit<RequestParams$s, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    fromDate?: DateInput;
    toDate?: DateInput;
}
type GetNFTContractTransfersJSONRequest = ReturnType<typeof serializeRequest$s>;
type GetNFTContractTransfersJSONResponse = SuccessResponse$u;
type GetNFTContractTransfersResponse = ReturnType<typeof deserializeResponse$u>;
...
declare function deserializeResponse$u(jsonResponse: GetNFTContractTransfersJSONResponse, request: GetNFTContractTransfersRequest, core: Core): EvmNftTransfer[];
declare function serializeRequest$s(request: GetNFTContractTransfersRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    format: "decimal" | "hex" | undefined;
    limit: number | undefined;
    cursor: string | undefined;
...
type OperationId$t = 'getNFTLowestPrice';
type PathParams$m = operations$1[OperationId$t]['parameters']['path'];
type QueryParams$q = operations$1[OperationId$t]['parameters']['query'];
type RequestParams$r = PathParams$m & QueryParams$q;
type SuccessResponse$t = operations$1[OperationId$t]['responses']['200']['content']['application/json'];
interface GetNFTLowestPriceRequest extends Camelize<Omit<RequestParams$r, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetNFTLowestPriceJSONRequest = ReturnType<typeof serializeRequest$r>;
type GetNFTLowestPriceJSONResponse = SuccessResponse$t;
type GetNFTLowestPriceResponse = ReturnType<typeof deserializeResponse$t>;
...
declare function deserializeResponse$t(jsonResponse: GetNFTLowestPriceJSONResponse, request: GetNFTLowestPriceRequest, core: Core): EvmNftTrade;
declare function serializeRequest$r(request: GetNFTLowestPriceRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
...
type OperationId$s = 'getNFTMetadata';
type PathParams$l = operations$1[OperationId$s]['parameters']['path'];
type QueryParams$p = operations$1[OperationId$s]['parameters']['query'];
type RequestParams$q = PathParams$l & QueryParams$p;
type SuccessResponse$s = operations$1[OperationId$s]['responses']['200']['content']['application/json'];
interface GetNFTMetadataRequest extends Camelize<Omit<RequestParams$q, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetNFTMetadataJSONRequest = ReturnType<typeof serializeRequest$q>;
type GetNFTMetadataJSONResponse = SuccessResponse$s;
type GetNFTMetadataResponse = ReturnType<typeof deserializeResponse$s>;
...
declare function deserializeResponse$s(jsonResponse: GetNFTMetadataJSONResponse, request: GetNFTMetadataRequest, core: Core): EvmNft;
declare function serializeRequest$q(request: GetNFTMetadataRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    format: "decimal" | "hex" | undefined;
    address: string;
    tokenId: string;
...
type OperationId$r = 'getNFTOwners';
type PathParams$k = operations$1[OperationId$r]['parameters']['path'];
type QueryParams$o = operations$1[OperationId$r]['parameters']['query'];
type RequestParams$p = PathParams$k & QueryParams$o;
type SuccessResponse$r = operations$1[OperationId$r]['responses']['200']['content']['application/json'];
interface GetNFTOwnersRequest extends Camelize<Omit<RequestParams$p, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetNFTOwnersJSONRequest = ReturnType<typeof serializeRequest$p>;
type GetNFTOwnersJSONResponse = SuccessResponse$r;
type GetNFTOwnersResponse = ReturnType<typeof deserializeResponse$r>;
...
declare function deserializeResponse$r(jsonResponse: GetNFTOwnersJSONResponse, request: GetNFTOwnersRequest, core: Core): EvmNft[];
declare function serializeRequest$p(request: GetNFTOwnersRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    format: "decimal" | "hex" | undefined;
    limit: number | undefined;
    cursor: string | undefined;
...
type OperationId$q = 'getNFTTokenIdOwners';
type PathParams$j = operations$1[OperationId$q]['parameters']['path'];
type QueryParams$n = operations$1[OperationId$q]['parameters']['query'];
type RequestParams$o = PathParams$j & QueryParams$n;
type SuccessResponse$q = operations$1[OperationId$q]['responses']['200']['content']['application/json'];
interface GetNFTTokenIdOwnersRequest extends Camelize<Omit<RequestParams$o, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetNFTTokenIdOwnersJSONRequest = ReturnType<typeof serializeRequest$o>;
type GetNFTTokenIdOwnersJSONResponse = SuccessResponse$q;
type GetNFTTokenIdOwnersResponse = ReturnType<typeof deserializeResponse$q>;
...
declare function deserializeResponse$q(jsonResponse: GetNFTTokenIdOwnersJSONResponse, request: GetNFTTokenIdOwnersRequest, core: Core): EvmNft[];
declare function serializeRequest$o(request: GetNFTTokenIdOwnersRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    format: "decimal" | "hex" | undefined;
    limit: number | undefined;
    cursor: string | undefined;
...
type OperationId$p = 'getNFTTrades';
type PathParams$i = operations$1[OperationId$p]['parameters']['path'];
type QueryParams$m = operations$1[OperationId$p]['parameters']['query'];
type RequestParams$n = PathParams$i & QueryParams$m;
type SuccessResponse$p = operations$1[OperationId$p]['responses']['200']['content']['application/json'];
interface GetNFTTradesRequest extends Camelize<Omit<RequestParams$n, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    fromDate?: DateInput;
    toDate?: DateInput;
}
type GetNFTTradesJSONRequest = ReturnType<typeof serializeRequest$n>;
type GetNFTTradesJSONResponse = SuccessResponse$p;
type GetNFTTradesResponse = ReturnType<typeof deserializeResponse$p>;
...
declare function deserializeResponse$p(jsonResponse: GetNFTTradesJSONResponse, request: GetNFTTradesRequest, core: Core): EvmNftTrade[];
declare function serializeRequest$n(request: GetNFTTradesRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    fromBlock: number | undefined;
    toBlock: string | undefined;
...
type OperationId$o = 'getNFTTransfersByBlock';
type PathParams$h = operations$1[OperationId$o]['parameters']['path'];
type QueryParams$l = operations$1[OperationId$o]['parameters']['query'];
type RequestParams$m = PathParams$h & QueryParams$l;
type SuccessResponse$o = operations$1[OperationId$o]['responses']['200']['content']['application/json'];
interface GetNFTTransfersByBlockRequest extends Camelize<Omit<RequestParams$m, 'chain'>> {
    chain?: EvmChainish;
}
type GetNFTTransfersByBlockJSONRequest = ReturnType<typeof serializeRequest$m>;
type GetNFTTransfersByBlockJSONResponse = SuccessResponse$o;
type GetNFTTransfersByBlockResponse = ReturnType<typeof deserializeResponse$o>;
...
declare function deserializeResponse$o(jsonResponse: GetNFTTransfersByBlockJSONResponse, request: GetNFTTransfersByBlockRequest, core: Core): EvmNftTransfer[];
declare function serializeRequest$m(request: GetNFTTransfersByBlockRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    limit: number | undefined;
    cursor: string | undefined;
    blockNumberOrHash: string;
...
type OperationId$n = 'getNFTTransfersFromToBlock';
type QueryParams$k = operations$1[OperationId$n]['parameters']['query'];
type RequestParams$l = QueryParams$k;
type SuccessResponse$n = operations$1[OperationId$n]['responses']['200']['content']['application/json'];
interface GetNFTTransfersFromToBlockRequest extends Camelize<Omit<RequestParams$l, 'chain' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    fromDate?: DateInput;
    toDate?: DateInput;
}
type GetNFTTransfersFromToBlockJSONRequest = ReturnType<typeof serializeRequest$l>;
type GetNFTTransfersFromToBlockJSONResponse = SuccessResponse$n;
type GetNFTTransfersFromToBlockResponse = ReturnType<typeof deserializeResponse$n>;
...
declare function deserializeResponse$n(jsonResponse: GetNFTTransfersFromToBlockJSONResponse, request: GetNFTTransfersFromToBlockRequest, core: Core): EvmNftTransfer[];
declare function serializeRequest$l(request: GetNFTTransfersFromToBlockRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    fromBlock: number | undefined;
    toBlock: number | undefined;
    fromDate: DateInput | undefined;
...
type OperationId$m = 'getNFTTransfers';
type PathParams$g = operations$1[OperationId$m]['parameters']['path'];
type QueryParams$j = operations$1[OperationId$m]['parameters']['query'];
type RequestParams$k = PathParams$g & QueryParams$j;
type SuccessResponse$m = operations$1[OperationId$m]['responses']['200']['content']['application/json'];
interface GetNFTTransfersRequest extends Camelize<Omit<RequestParams$k, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetNFTTransfersJSONRequest = ReturnType<typeof serializeRequest$k>;
type GetNFTTransfersJSONResponse = SuccessResponse$m;
type GetNFTTransfersResponse = ReturnType<typeof deserializeResponse$m>;
...
declare function deserializeResponse$m(jsonResponse: GetNFTTransfersJSONResponse, request: GetNFTTransfersRequest, core: Core): EvmNftTransfer[];
declare function serializeRequest$k(request: GetNFTTransfersRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    format: "decimal" | "hex" | undefined;
    limit: number | undefined;
    cursor: string | undefined;
...
type OperationId$l = 'getWalletNFTCollections';
type PathParams$f = operations$1[OperationId$l]['parameters']['path'];
type QueryParams$i = operations$1[OperationId$l]['parameters']['query'];
type RequestParams$j = PathParams$f & QueryParams$i;
type SuccessResponse$l = operations$1[OperationId$l]['responses']['200']['content']['application/json'];
interface GetWalletNFTCollectionsRequest extends Camelize<Omit<RequestParams$j, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetWalletNFTCollectionsJSONRequest = ReturnType<typeof serializeRequest$j>;
type GetWalletNFTCollectionsJSONResponse = SuccessResponse$l;
type GetWalletNFTCollectionsResponse = ReturnType<typeof deserializeResponse$l>;
...
declare function deserializeResponse$l(jsonResponse: GetWalletNFTCollectionsJSONResponse, request: GetWalletNFTCollectionsRequest, core: Core): EvmNftCollection[];
declare function serializeRequest$j(request: GetWalletNFTCollectionsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    limit: number | undefined;
    cursor: string | undefined;
    address: string;
...
type OperationId$k = 'getWalletNFTs';
type PathParams$e = operations$1[OperationId$k]['parameters']['path'];
type QueryParams$h = operations$1[OperationId$k]['parameters']['query'];
type RequestParams$i = PathParams$e & QueryParams$h;
type SuccessResponse$k = operations$1[OperationId$k]['responses']['200']['content']['application/json'];
interface GetWalletNFTsRequest extends Camelize<Omit<RequestParams$i, 'chain' | 'token_addresses' | 'address'>> {
    chain?: EvmChainish;
    tokenAddresses?: EvmAddressish[];
    address: EvmAddressish;
}
type GetWalletNFTsJSONRequest = ReturnType<typeof serializeRequest$i>;
type GetWalletNFTsJSONResponse = SuccessResponse$k;
type GetWalletNFTsResponse = ReturnType<typeof deserializeResponse$k>;
...
declare function deserializeResponse$k(jsonResponse: GetWalletNFTsJSONResponse, request: GetWalletNFTsRequest, core: Core): EvmNft[];
declare function serializeRequest$i(request: GetWalletNFTsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    format: "decimal" | "hex" | undefined;
    limit: number | undefined;
...
type OperationId$j = 'getWalletNFTTransfers';
type PathParams$d = operations$1[OperationId$j]['parameters']['path'];
type QueryParams$g = operations$1[OperationId$j]['parameters']['query'];
type RequestParams$h = PathParams$d & QueryParams$g;
type SuccessResponse$j = operations$1[OperationId$j]['responses']['200']['content']['application/json'];
interface GetWalletNFTTransfersRequest extends Camelize<Omit<RequestParams$h, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type GetWalletNFTTransfersJSONRequest = ReturnType<typeof serializeRequest$h>;
type GetWalletNFTTransfersJSONResponse = SuccessResponse$j;
type GetWalletNFTTransfersResponse = ReturnType<typeof deserializeResponse$j>;
...
declare function deserializeResponse$j(jsonResponse: GetWalletNFTTransfersJSONResponse, request: GetWalletNFTTransfersRequest, core: Core): EvmNftTransfer[];
declare function serializeRequest$h(request: GetWalletNFTTransfersRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    format: "decimal" | "hex" | undefined;
...
type OperationId$i = 'reSyncMetadata';
...
type RequestParams$g = PathParams$c & QueryParams$f;
type SuccessResponse$i = operations$1[OperationId$i]['responses']['200']['content']['application/json'];
interface ReSyncMetadataRequest extends Camelize<Omit<RequestParams$g, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type ReSyncMetadataJSONRequest = ReturnType<typeof serializeRequest$g>;
type ReSyncMetadataJSONResponse = SuccessResponse$i;
type ReSyncMetadataResponse = ReturnType<typeof deserializeResponse$i>;
...
declare function serializeRequest$g(request: ReSyncMetadataRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
...
declare function deserializeResponse$i(jsonResponse: ReSyncMetadataJSONResponse): {
    status: string;
};

type OperationId$h = 'searchNFTs';
...
interface SearchNFTsRequest extends Camelize<Omit<RequestParams$f, 'chain' | 'addresses' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    addresses?: EvmAddressish[];
    fromDate?: DateInput;
    toDate?: DateInput;
}
type SearchNFTsJSONRequest = ReturnType<typeof serializeRequest$f>;
type SearchNFTsJSONResponse = SuccessResponse$h;
type SearchNFTsResponse = ReturnType<typeof deserializeResponse$h>;
...
declare function deserializeResponse$h(jsonResponse: SearchNFTsJSONResponse, request: SearchNFTsRequest, core: Core): {
    token: EvmNft;
    tokenHash: string;
...
declare function serializeRequest$f(request: SearchNFTsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    format: "decimal" | "hex" | undefined;
    q: string;
...
type OperationId$g = 'syncNFTContract';
type PathParams$b = operations$1[OperationId$g]['parameters']['path'];
type QueryParams$d = operations$1[OperationId$g]['parameters']['query'];
type RequestParams$e = PathParams$b & QueryParams$d;
type SuccessResponse$g = operations$1[OperationId$g]['responses']['201'];
interface SyncNFTContractRequest extends Camelize<Omit<RequestParams$e, 'chain' | 'address'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
}
type SyncNFTContractJSONRequest = ReturnType<typeof serializeRequest$e>;
type SyncNFTContractJSONResponse = SuccessResponse$g;
type SyncNFTContractResponse = ReturnType<typeof deserializeResponse$g>;
...
declare function deserializeResponse$g(): {
    success: boolean;
};
declare function serializeRequest$e(request: SyncNFTContractRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    address: string;
};

type OperationId$f = 'resolveAddress';
type PathParams$a = operations$1[OperationId$f]['parameters']['path'];
type RequestParams$d = PathParams$a;
type SuccessResponse$f = operations$1[OperationId$f]['responses']['200']['content']['application/json'];
interface ResolveAddressRequest extends Camelize<Omit<RequestParams$d, 'address'>> {
    address?: EvmAddressish;
}
type ResolveAddressJSONRequest = ReturnType<typeof serializeRequest$d>;
type ResolveAddressJSONResponse = SuccessResponse$f;
type ResolveAddressResponse = ReturnType<typeof deserializeResponse$f>;
...
declare function deserializeResponse$f(jsonResponse: ResolveAddressJSONResponse): {
    name: string;
};
declare function serializeRequest$d(request: ResolveAddressRequest, core: Core): {
    address: string | undefined;
};

type OperationId$e = 'resolveDomain';
type PathParams$9 = operations$1[OperationId$e]['parameters']['path'];
type QueryParams$c = operations$1[OperationId$e]['parameters']['query'];
type RequestParams$c = PathParams$9 & QueryParams$c;
type SuccessResponse$e = operations$1[OperationId$e]['responses']['200']['content']['application/json'];
interface ResolveDomainRequest extends Camelize<RequestParams$c> {
}
type ResolveDomainJSONRequest = ReturnType<typeof serializeRequest$c>;
type ResolveDomainJSONResponse = SuccessResponse$e;
type ResolveDomainResponse = ReturnType<typeof deserializeResponse$e>;
...
declare function serializeRequest$c(request: ResolveDomainRequest): {
    currency: "eth" | "0x1" | undefined;
    domain: string;
};
declare function deserializeResponse$e(jsonResponse: ResolveDomainJSONResponse, request: ResolveDomainRequest, core: _moralisweb3_common_core__default): {
    address: EvmAddress;
};

type OperationId$d = 'getTransaction';
type PathParams$8 = operations$1[OperationId$d]['parameters']['path'];
type QueryParams$b = operations$1[OperationId$d]['parameters']['query'];
type RequestParams$b = PathParams$8 & QueryParams$b;
type SuccessResponse$d = operations$1[OperationId$d]['responses']['200']['content']['application/json'];
interface GetTransactionRequest extends Camelize<Omit<RequestParams$b, 'chain'>> {
    chain?: EvmChainish;
}
type GetTransactionJSONRequest = ReturnType<typeof serializeRequest$b>;
type GetTransactionJSONResponse = SuccessResponse$d;
type GetTransactionResponse = ReturnType<typeof deserializeResponse$d>;
...
declare function serializeRequest$b(request: GetTransactionRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    transactionHash: string;
};
declare function deserializeResponse$d(jsonResponse: GetTransactionJSONResponse, request: GetTransactionJSONRequest, core: Core): EvmTransaction;

type OperationId$c = 'getWalletTransactions';
type PathParams$7 = operations$1[OperationId$c]['parameters']['path'];
type QueryParams$a = operations$1[OperationId$c]['parameters']['query'];
type RequestParams$a = PathParams$7 & QueryParams$a;
type SuccessResponse$c = operations$1[OperationId$c]['responses']['200']['content']['application/json'];
interface GetWalletTransactionsRequest extends Camelize<Omit<RequestParams$a, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    fromDate?: DateInput;
    toDate?: DateInput;
}
type GetWalletTransactionsJSONRequest = ReturnType<typeof serializeRequest$a>;
type GetWalletTransactionsJSONResponse = SuccessResponse$c;
type GetWalletTransactionsResponse = ReturnType<typeof deserializeResponse$c>;
...
declare function serializeRequest$a(request: GetWalletTransactionsRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    fromBlock: number | undefined;
    toBlock: number | undefined;
    fromDate: DateInput | undefined;
...
declare function deserializeResponse$c(jsonResponse: GetWalletTransactionsJSONResponse, request: GetWalletTransactionsJSONRequest, core: Core): EvmTransaction[];

type OperationId$b = 'getWalletTransactionsVerbose';
type PathParams$6 = operations$1[OperationId$b]['parameters']['path'];
type QueryParams$9 = operations$1[OperationId$b]['parameters']['query'];
type RequestParams$9 = PathParams$6 & QueryParams$9;
type SuccessResponse$b = operations$1[OperationId$b]['responses']['200']['content']['application/json'];
interface GetWalletTransactionsVerboseRequest extends Camelize<Omit<RequestParams$9, 'chain' | 'address' | 'from_date' | 'to_date'>> {
    chain?: EvmChainish;
    address: EvmAddressish;
    fromDate?: DateInput;
    toDate?: DateInput;
}
type GetWalletTransactionsVerboseJSONRequest = ReturnType<typeof serializeRequest$9>;
type GetWalletTransactionsVerboseJSONResponse = SuccessResponse$b;
type GetWalletTransactionsVerboseResponse = ReturnType<typeof deserializeResponse$b>;
...
declare function serializeRequest$9(request: GetWalletTransactionsVerboseRequest, core: Core): {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    fromBlock: number | undefined;
    toBlock: number | undefined;
    fromDate: DateInput | undefined;
...
declare function deserializeResponse$b(jsonResponse: GetWalletTransactionsVerboseJSONResponse, request: GetWalletTransactionsVerboseJSONRequest, core: Core): EvmTransaction[];
...
declare const operations: (_moralisweb3_common_core.Operation<EndpointWeightsRequest, undefined, {
...
}> | _moralisweb3_common_core.PaginatedOperation<GetErc20MintsRequest, {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    limit: number | undefined;
    cursor: string | undefined;
    fromBlock: number | undefined;
    ...
    to_wallet: string;
    value: string;
}[] | undefined> | _moralisweb3_common_core.Operation<GetMultipleNFTsRequest, {
    chain: "0x1" | "0x5" | "0xaa36a7" | "0x89" | "0x13881" | "0x38" | "0x61" | "0xa86a" | "0xa869" | "0xfa" | "0x19" | "0x152" | "0x2a15c308d" | "0xa4B1";
    normalizeMetadata: boolean | undefined;
    tokens: {
        tokenAddress: string;
